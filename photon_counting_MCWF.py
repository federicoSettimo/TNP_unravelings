...
ax.set_ylabel(r'Moments', fontsize=14)
ax.set_xlabel(r'$t$', fontsize=14)
ax.set_ylim([-.55,1.55])

markevery = len(t)//10
axx.plot(t, trace_0[0], color='red', markevery=markevery, marker='o', lw=0, fillstyle='none')
axx.plot(t, trace_ex_0[0], label=rf'$\zeta={z0}$', color='red', markevery=len(t), fillstyle='none', marker='o')
axx.plot(t, trace_1[0], color='green', markevery=markevery, marker='x', lw=0, fillstyle='none')
axx.plot(t, trace_ex_1[0], label=rf'$\zeta={z1}$', color='green', markevery=len(t), fillstyle='none', marker='x')
axx.plot(t, trace_2[0], color='blue', markevery=markevery, marker='d', lw=0, fillstyle='none')
axx.plot(t, trace_ex_2[0], label=rf'$\zeta={z2}$', color='blue', markevery=len(t), fillstyle='none', marker='d')
axx.plot(t, trace_3[0], color='orange', markevery=markevery, marker='s', lw=0, fillstyle='none')
axx.plot(t, trace_ex_3[0], label=rf'$\zeta={z3}$', color='orange', markevery=len(t), fillstyle='none', marker='s')
axx.plot(t, trace_4[0], color='cyan', markevery=markevery, marker='v', lw=0, fillstyle='none')
axx.plot(t, trace_ex_4[0], label=rf'$\zeta={z4}$', color='cyan', markevery=len(t), fillstyle='none', marker='v')

axx.set_ylabel(r'$1-\operatorname{tr}\rho_\zeta$', fontsize=12)
axx.set_xticks([])
